...
if __name__ == "__main__":
    ...
    ground("./data/csqa/statement/train.statement.jsonl", "./data/cpnet/concept.txt", "./data/cpnet/matcher_patterns.json", "./data/csqa/grounded/train.grounded.jsonl", 10, False)
    ground("./data/csqa/statement/dev.statement.jsonl", "./data/cpnet/concept.txt", "./data/cpnet/matcher_patterns.json", "./data/csqa/grounded/dev.grounded.jsonl", 10, False)
    ground("./data/csqa/statement/test.statement.jsonl", "./data/cpnet/concept.txt", "./data/cpnet/matcher_patterns.json", "./data/csqa/grounded/test.grounded.jsonl", 10, False)
